    ...
    return (
      <ScrollView>
        <Markdown markdownStyles={{block: {backgroundColor: 'white', padding:10, margin: 10},text:{fontSize: 13, color: 'black', fontFamily:'samim'},strong: {fontFamily: 'samim'},h1:{padding: 10, paddingTop: 20, fontSize: 22, color:'grey',fontFamily:'samim'}}}>
          ...
          'جهت رعایت حریم خصوصی شما، این اطلاعات قابل اتصال به پاسخ‌های شما و دیگر اطلاعات جلسه‌ها نیست، و بعد از اعلام نتایج از بین خواهد رفت.' +
          ' برای اطلاع از شرایط شرکت در قرعه‌کشی به صفحهٔ «راهنما» مراجعه نمایید.' +
          '\n'+
          'به دلیل محدودیت‌های اخلاقی در پژوهش‌های آکادمیک، فشردن دکمهٔ «تایید» برای اولین بار به منزلهٔ شرکت شما در این پژوهش تلقی می‌شود. ' +
          '\n\n'
          }
        </Markdown>
