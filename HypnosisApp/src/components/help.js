    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <Markdown markdownStyles={{block: {padding: 10},text:{fontSize: 16, color: 'black', fontFamily:'samim'},strong: {fontFamily: 'samim'},h3:{padding: 10, paddingTop: 20, fontSize: 22, color:'grey',fontFamily:'samim'}}}>
          ...
          '\n\n' +
          'تنها برای جلسه‌هایی که به طور کامل گوش دهید امتیاز منظور خواهد شد. پاسخ به پرسش‌های قبل و بعد از برخی جلسه‌ها نیز در کسب امتیاز موثر است. اگر از دکمهٔ «بازگشن» سیستم (مثلث) نیز استفاده کنید، ممکن است برخی از امتیازها برایتان منظور نشود.' +
          '\n\n' +
